...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        # Check how many copies of gene in a person
        ...
        # If person has no mother or a father 
        if people[person]["mother"] is None and people[person]["father"] is None:
            gene_probability = PROBS["gene"][genes]

        # If person has a mother or a father
        else:
            # Conditions for Mother
            ...
            if person in one_gene:
                ...
                gene_probability = ( 1- parents["father"]) * (1 - parents["mother"])

        # Probability of person having the trait
