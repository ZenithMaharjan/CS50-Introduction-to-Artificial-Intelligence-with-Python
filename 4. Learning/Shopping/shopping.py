...
def evaluate(labels, predictions):
    ...
    total_actual_incorrect = 0
    
    for i in len(labels):
        if labels[i] == 1:
            total_actual_correct += 1

            if labels[i] == predictions[i]:
                correct += 1
        else:
            total_actual_incorrect += 1
            if labels[i] == predictions[i]:
                incorrect += 1
    ...
    sensitivity = correct/total_actual_correct
    specificity = incorrect/total_actual_incorrect
