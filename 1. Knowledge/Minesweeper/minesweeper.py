...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # 1. Marking Cell is Moved
        self.moves_made.add(cell)

        # 2. Marking Cell is Safe
        self.mark_safe(cell)

        # 3. Adding Sentences to AI's knowledge base
        neighbours = set()
        for i in range(cell[0] - 1, cell[0] + 2):
            for j in range(cell[1] - 1, cell[1] + 2):
                ...
                # Ignoring already safe Cells
                if (i, j) in self.safes:
                    continue

                # Ignoring already mine Cells and reducing count by 1
        ...
        # 4. Marking safes and mines cells and infering new knowledge
